...
import Foundation
struct ForgetPasswordModel_1 : Codable {
    let status : Bool?
    let code : String?
    let data : ForgetPasswordData_1?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent(ForgetPasswordData_1.self, forKey: .data)
    }

}

struct ForgetPasswordData_1 : Codable {
