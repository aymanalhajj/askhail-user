...
extension EditCategoryVC{
    ...
    func getSectionsData() {
        ...
        ApiServices.instance.getPosts(methodType: .get, parameters: nil, url: "\(hostName)user-update-advertisement/edit-sections?advertisement_id=\(Ad_id)") { (data : AdvEditSectionModel?, String) in
    ...
    func updateSection() {
        ...
        ApiServices.instance.getPosts(methodType: .post, parameters: Parameters as [String : AnyObject], url: "\(hostName)user-update-advertisement/update-sections") { (data : SuccessEditSectionModel?, String) in
